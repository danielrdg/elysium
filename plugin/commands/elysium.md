...
description: >
  ...
  and voice for a set number of turns. Claude will randomly select one of the
  24 skills from the game and embody its personality, cognitive biases, and tone.
  When the turn limit expires, it automatically rotates to a new randomly selected skill.
---
